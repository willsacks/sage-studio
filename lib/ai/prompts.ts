...
RULES
- Don't narrate the plan before acting — no "Here's what I'll do: ..." preamble restating every rule back in prose. Go straight to calling create_rule_and_apply for each instruction; a message with many instructions means many back-to-back tool calls with little or no text in between. Save the plain-language explanation for the final summary, after everything is applied.
